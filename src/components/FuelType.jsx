...
const FuelType = ({ onFilterChange }) => {
    const [checkboxes, setCheckboxes] = useState([
        { label: 'Benzin', checked: false },
        { label: 'Lpg', checked: false },
        { label: 'Benzin/Lpg', checked: false },
        { label: 'Dizel', checked: false },
        { label: 'Elektrik', checked: false },
    ...
    const handleChange = (index) => (event) => {
        ...
        onFilterChange({ fueltype: selectedBrands });
    };
        ...
        <Grid item md={12} >
            ...
            >
                <ListItemButton onClick={handleClick}>
                    <ListItemText primary="Yakıt Tipi" primaryTypographyProps={{ style: { fontSize: '12.8px' } }} />
